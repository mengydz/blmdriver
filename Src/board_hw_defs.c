	...
	[0] = {
		...
		.sFilterConfig = {
			[0] = {
				...
				.FilterIdHigh = (((((uint32_t)UAVCAN_GIMBAL_SET_SPEED_DATA_TYPE_ID<<8) & 0xFFFF00)<<3)>>16) & 0xFFFF,
				.FilterIdLow = (uint16_t)(((UAVCAN_GIMBAL_SET_SPEED_DATA_TYPE_ID<<8) & 0xFFFF00)<<3)|CAN_ID_EXT,			//0x28 is can nod ids
